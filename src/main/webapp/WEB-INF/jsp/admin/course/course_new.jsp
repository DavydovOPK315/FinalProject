...
<main>
    ...
    <form action="${app}/admin/courses/new" method="post">
        ...
        <table class="tg">
            ...
            <tr>
                <td>default</td>
                <td><input type="text" name="name" minlength="3" maxlength="45" required></td>
                ...
                <td>
                    <textarea type="text" name="description" minlength="5" maxlength="500" required>
                        ${requestScope.course.getDescription()}
                    </textarea></td>
